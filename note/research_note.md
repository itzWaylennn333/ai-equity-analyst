...
![Share price: a fallen angel near its lows](../outputs/charts/01_price_history.png)
...
![Revenue growth is decelerating](../outputs/charts/02_revenue_growth.png)

![Operating leverage despite gross-margin pressure](../outputs/charts/03_margins.png)
...
![The core tension: volume up, take-rate down](../outputs/charts/05_tpv_takerate.png)

![Aggressive buybacks shrinking the share count](../outputs/charts/06_shares_buybacks.png)
...
![Free cash flow generation is substantial](../outputs/charts/04_fcf.png)
...
![DCF sensitivity: the market price is off the grid](../outputs/charts/07_dcf_sensitivity.png)
...
![PayPal trades at a steep discount to payment peers](../outputs/charts/09_peer_multiples.png)
...
![Football field: valuation by method](../outputs/charts/08_football_field.png)
